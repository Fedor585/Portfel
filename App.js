  ...
  const MarketRow = ({ sym }) => {
    ...
    return (
      <View style={styles.row}>
        ...
        {/* правая часть — компактно: USD + % в одну строку, ниже маленькая ₽ */}
        <View style={styles.priceBlock}>
          {m ? (
            ...
            <Text style={styles.priceNow}>—</Text>
          )}
        </View>
      </View>
    );
...
const styles = StyleSheet.create({
  ...
  row: {
    marginHorizontal: 16, marginVertical: 6, paddingVertical: 10, paddingHorizontal: 14,
    borderRadius: 14, backgroundColor: "#111827", flexDirection: "row", justifyContent: "space-between",
  ...
  priceBlock: { maxWidth: "56%", alignItems: "flex-end", rowGap: 3 },
  priceNow: { color: "#E5E7EB", fontWeight: "800" },
  priceRub: { color: "#9CA3AF", fontSize: 12, marginTop: 2 },

  pill: { paddingVertical: 2, paddingHorizontal: 8, borderRadius: 999, borderWidth: 1 },
