      ...
      >
        ...
        {tab === "market" && (
          <FlatList
            ...
            refreshControl={
              <RefreshControl refreshing={isRefreshing} onRefresh={onPullRefresh} tintColor="#E5E7EB" />
            }
          />
        )}
...
const styles = StyleSheet.create({
  ...
  /* правый блок с ценами — компактно и без переносов */
  priceBlock: { marginLeft: "auto", alignItems: "flex-end", rowGap: 2, maxWidth: "40%" },
  priceNow: { color: "#E5E7EB", fontWeight: "800" },
  priceRub: { color: "#9CA3AF", fontWeight: "700", fontSize: 12 },

  /* колонка с процентами — по центру карточки */
  changeBlock: { position: "absolute", left: "50%", transform: [{ translateX: -25 }], top: "50%", marginTop: -12 },
